...
(function() {
  ...
  function W(k, m, v, u, y) {
    ...
    this.theme && s(this.parent) && s(m) && s(u)
      ...
      : this.parent &&
        (this.parent.themeOptions && this.parent.themeOptions[m]) &&
        (null === u
            ...
            k.midAngle > Math.PI / 2 - t && k.midAngle < Math.PI / 2 + t
              ...
              : k.midAngle > (3 * Math.PI) / 2 - t &&
                ...
                c < l.indexLabelTextBlock.x
                  ? (c = l.indexLabelTextBlock.x + 15)
                  : "left" === k.hemisphere &&
                    ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) &&
                    (c = a.indexLabelTextBlock.x - 15)),
        ...
        function b() {
          ...
          for (var l, p = 1; p < h; p++) {
            ...
            for (var n = H.length - 1; 0 <= n; n--)
              !H[n].isDirty &&
                (H[n].textBlock.y < e && H[n].textBlock.y + H[n].height > e) &&
                ((l = q(n)),
                !(l >= H.length - 1) &&
        ...
        for (var k = 0; k < this.chart.data.length; k++)
          (c = this.chart.data[k]),
            (b = c.getDataPointAtX(a, !1)) &&
              (b.dataPoint && !s(b.dataPoint.y) && c.visible) &&
  ...
  y.version = "v3.2 GA";
  window.CanvasJS &&
    (y && !window.CanvasJS.Chart) &&
    (window.CanvasJS.Chart = y);
})();
